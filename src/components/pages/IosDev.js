      ...
      <>
        <div className="container-main">
          ...
          <p className="description-main">
            ...
            <br/>
            Technologies used: Xcode Storyboards, Swift, CocoaPods, Alamofire
          </p>
          <div className='container-project'>
            <div className="container-ios">
              ...
              <p className="description">
                ...
                Features include: scroll feed, logging in/out, tweeting, retweeting, replying, and liking posts from user's official Twitter account.
                <br/>
            ...
            <div className='container-ios'>
              ...
              <p className="description">
                ...
                Features include: "now playing" scroll feed, "superhero movies" scroll feed, viewing movie description.
                <br/>
            ...
            <div className='container-ios'>
              ...
              <p className="description">
                Replicated Instagram and implemented the following features: logging in/out, posting picture from camera roll and description,
